...
if __name__ == "__main__":
    ...
    data=census_qa.CensusQA(dirPath=dirPath,split='train',config={
        'rescale_range': [1.2,1.2],
        'rescale_to_crop_size_first': True,
        'crop_params': {
            "crop_size":[960,1280],#5953x4504  6164x4631  6234x4769
            "pad":0,
    ...
    dataLoader = torch.utils.data.DataLoader(data, batch_size=1, shuffle=True, num_workers=0, collate_fn=census_qa.collate)
