...
if __name__ == "__main__":
    ...
    if len(sys.argv)>3:
        ...
        repeat=1
    data=my_dataset.MyDataset(dirPath=dirPath,split='train',config={
        'batch_size':1,
    ...
    dataLoader = torch.utils.data.DataLoader(data, batch_size=1, shuffle=True, num_workers=0, collate_fn=my_dataset.collate)
