...
if __name__ == "__main__":
    ...
    if len(sys.argv)>3:
        ...
        repeat=1
    data=rvl_cdip_class.RVLCDIPClass(dirPath=dirPath,split='train',config={
    ...
    dataLoader = torch.utils.data.DataLoader(data, batch_size=1, shuffle=False, num_workers=0, collate_fn=rvl_cdip_class.collate)
